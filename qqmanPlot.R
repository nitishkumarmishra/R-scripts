...
## ------------------------------------------------------------------------
manhattan(manhattan.data, col=c("blue4","black", "red4"), suggestiveline = F, genomewideline = F, highlight=snpsOfInterest, cex = 0.75,ymax = 15)
#manhattan(gwasResults, main="Manhattan Plot", ylim=c(0,10), cex=0.6, cex.axis=0.9, col=c("blue4", "orange4", "green4", "red", "cyan", "purple", "pink4", "red4"), suggestiveline=F, genomewideline=F, chrlabs=c(1:20, "P", "Q"))
